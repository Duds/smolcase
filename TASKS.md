...
> Face spikes retired 2026-09-10: source model shipped natively in `FaceGpuRenderer` (two-pass GPU parity).
> Recommended: implement reset-to-scratch factory reset (spec + plan ready).

| ID | Task | Risk | Status |
|----|------|------|--------|
| 20260910-001 | [[docs/07-plans/2026-09-10-gpu-face-parity|Native two-pass GPU face parity]] | Medium | ✅ Implemented — [[docs/06-specs/2026-09-10-gpu-face-parity-design|design]] locked in, `face/FaceGpuRenderer.kt` |
| 20260909-001 | [[_tasks/20260909-001-smolcase-face-spike|SMOLCASE face sphere architecture spike]] | 🟡 Medium | 🗄 Retired 2026-09-10 — outputs shipped natively |
...
- 2026-09-10: Implemented native two-pass GPU face parity (FaceGpuRenderer, FaceFrame, FaceParameters, ExpressionFaceModel), retired all three face spikes, and locked the build in with commits. Unit tests 57/57 passing.
